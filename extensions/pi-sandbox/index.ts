 ...
 * - ~/.pi/agent/extensions/pi-sandbox/sandbox.json (global)
...
function loadConfig(cwd: string): SandboxConfig {
	...
	const globalConfigPath = join(getAgentDir(), "extensions", "pi-sandbox", "sandbox.json");
